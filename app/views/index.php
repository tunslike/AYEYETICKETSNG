...
<div class="ticketList">
    ...
    <div class="listFilter">
            <a href="#" title="Search all events!">
            <div class="filterractive">
                All
            </div></a>
            <a href="#" title="Events today!"><div class="filterDiv">
                Happening Today
            </div></a>
            <a href="#" title="Happening this week!"><div class="filterDiv">
                Happening This Week
            </div></a>
            <a href="#" title="This month!"><div class="filterDiv">
                This Month only
            </div></a>
    </div>
    ...
    <div class="eventListWindow">
        <div class="eventItem">
            <a href="<?php echo URLROOT; ?>/events/find" title="Burna Boy - Twice as ALL">
            <div class="poster" style="background-image: url(<?php echo URLROOT; ?>/public/images/eventimg2.jpeg);"></div>
