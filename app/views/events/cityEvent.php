...
<?php foreach($data['states'] as $state): ?>
            ...
            <a href="<?php echo URLROOT; ?>/?filter=today#eventList" title="Events today!"><div class="<?php echo ($data['type'] == 'today') ? 'filterractive' : 'filterDiv'; ?>">
